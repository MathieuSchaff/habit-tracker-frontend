ALTER TABLE "products" DROP CONSTRAINT "products_kind_category_check";--> statement-breakpoint
ALTER TABLE "products" ADD CONSTRAINT "products_kind_category_check" CHECK ((
        ...
        ("products"."category" = 'haircare'   AND "products"."kind" IN ('shampoo','conditioner','hair-mask','hair-serum','hair-oil','styling','hair-color')) OR
