...
export const TAG_HIT_RATE_BUDGET: TagBudgetTable = {
  skincare: {
    ...
    'non-comedogene': { max: 0.12 }, // hit_rate=11.1% · rebaselined after kit/bundle drop shrank corpus (sensitive)
  ...
  solaire: {
    ...
    'sebo-regulateur': { max: 0.18 }, // hit_rate=15.5% · rebaselined after catalogue refresh (6596)
