...
const CHEMICAL_FILTER_PATTERNS = [
  ...
  'bisoctrizole',
  'bemotrizinol',
  // Long-form INCI names for modern EU/Asian filters: brands usually list these,
  // not the short synonyms above. `normalize` keeps hyphens, so hyphenated forms match.
