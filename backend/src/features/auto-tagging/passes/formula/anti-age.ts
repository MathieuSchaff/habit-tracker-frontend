...
// across the whole catalogue regardless of positioning. The gate keys on the
// dominant anti-age MARKETING vocabulary: the retinoid family + bakuchiol
...
// (gold-strict boundary), and every candidate exclusion killed real positives.
// `\baging\b` (not bare `aging`) avoids matching "packaging".
