...
// Positioning gate for `eclat-teint-uniforme` (re-emits an algo-derm slug, ADR-0004, R5).
...
// different primary positioning). Gold set: P 0.048→0.800, R 0.019→1.000.
const ECLAT_POSITION_RE =
